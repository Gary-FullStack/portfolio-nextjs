              ...
              <div className="px-3">
                ...
                >
                  ...
                  <div className="lg:py-10 md:py-6 sm:py-6 cursor-all-scroll">
                    <Slider {...settings}>
                      <img src="/mongodb.png" alt="mongodb icon" className="h-12"/>
                      <img src="/reactjs.png" alt="reactjs icon" className="h-12"/>
                      <img src="/nextjs.png" alt="nextjs icon" className="h-12"/>
                      <img src="/expressjs.png" alt="expressjs icon" className="h-12"/>
                      <img src="/nodejs.png" alt="nodejs icon" className="h-12"/>
                      <img src="/redux.png" alt="redux icon" className="h-12"/>
                      <img src="/firebase.png" alt="firebase icon" className="h-12" />
                    </Slider>
                  </div>
