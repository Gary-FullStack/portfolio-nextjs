...
export default function DiagonalDrawer({isOpen, setIsOpen, setSelectedIndex1, selectedIndex1}) {
  ...
  return (
    ...
    <React.Fragment>
      <div className='relative'>
        <div className={`z-50 ${pathname === '/' ? 'top-[0px]': 'top-[100px]'} cursor-pointer fixed h-14 lg:w-24 lg:h-24 bg-[#48AFDE] flex justify-center items-center rounded-br-3xl`}>
      ...
      <header className={`fixed w-full transition-all duration-500 z-40 ${pathname === '/' ? 'top-0': 'top-[100px]'}`}>
          <div className='relative'>              
              <div className='z-20 absolute transform-gpu ease-in-out duration-500 transition-all scale-100 -translate-x-none -translate-y-none opacity-95 bg-[#223740] bg-opacity-95 w-full h-screen flex flex-col sm:flex-row lg:flex-col items-center justify-center  '>
                ...
                <section className='mt-14 sm:mt-12 text-center relative sm:absolute lg:relative sm:right-0 lg:right-0 h-0 sm:h-full lg:h-auto '>
                  ...
                  <div className='flex flex-row sm:flex-col lg:flex-row'>
                    ...
                    <a href='https://twitter.com/FullstackGary'
                     className='text-gray-300 hover:text-white transition-all duration-3000'
                    >
                    <svg
                     stroke="currentColor"
                     fill="currentColor"
                   ...
                   >
                    ...
                    <a href='https://www.linkedin.com/in/gary-minor-801602253/'
                     className='text-gray-300 hover:text-white transition-all duration-3000'
                    >
