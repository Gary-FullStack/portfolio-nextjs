  ...
  return (
    ...
    <React.Fragment>
      <div className='relative'>
        <div className={`z-50 ${pathname === '/' ? 'top-[0px]': 'top-0'} cursor-pointer fixed h-14 lg:w-24 lg:h-24 bg-[#48AFDE] flex justify-center items-center rounded-br-3xl`}>
